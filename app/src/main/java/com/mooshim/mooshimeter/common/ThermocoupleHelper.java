    ...
    public static class helper {
        ...
        public double voltsToDegC(double v) {
            ...
            if (coefficients.length != 10) {
                Timber.w("Coefficients vector is too short, result might be inaccurate");
            }
            ...
            if (out < low || out > high) {
                Timber.w("Using polynomial fit outside of its recommended range, result might be inaccurate");
            }
            return out;
        }
    }
